...
### מערכת לוגים מתקדמת
- קבצי לוג מופרדים לפי סוג:
  - `bot.log` - לוגים כלליים של הבוט
  - `debug.log` - לוגים מפורטים לדיבאג
  - `user_actions.log` - תיעוד פעולות משתמש
  - `errors.log` - שגיאות ובעיות
- תיעוד מפורט של תקשורת LLM:
  - פרומפטים שנשלחים
  - תשובות שמתקבלות
  - שרשראות עיבוד
  - שימוש בכלים
...
- הגבלת לוגים בטרמינל
- השתקת לוגים מיותרים מספריות חיצוניות 